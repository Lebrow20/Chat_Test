    ...
    <div class="wrapper">
        <section class="chat-area">
            ...
            <form action="#" class="typing-area" autocomplete="off">
                ...
                <!-- <input type="text" name="message" class="input-field"  placeholder="Type a message here..." oninput="capitalizeFirstLetter(this);" oninput="adjustInputWidth(this);"> -->
                <textarea name="message" class="input-field"  placeholder="Taper le message ici..." style="width : 350px" oninput="capitalizeFirstLetter(this);" oninput="adjustTextareaHeight(this);"></textarea>
                <div class="round">
                        <input type="file" class="input-field" id="inputFile" name="image">
                        <svg id="sendFile" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="gray" class="bi bi-paperclip" viewBox="0 0 16 16">
                            <path d="M4.5 3a2.5 2.5 0 0 1 5 0v9a1.5 1.5 0 0 1-3 0V5a.5.5 0 0 1 1 0v7a.5.5 0 0 0 1 0V3a1.5 1.5 0 1 0-3 0v9a2.5 2.5 0 0 0 5 0V5a.5.5 0 0 1 1 0v7a3.5 3.5 0 1 1-7 0V3z"/>
                        </svg> 
                </div>
                <button id="resetFileSend">
                    <svg id="sendFile" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-telegram" viewBox="0 0 16 16">
